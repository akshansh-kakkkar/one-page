...
export default function Home() {
  return (
    <div className="relative min-h-screen flex flex-col justify-center gap-4 items-center text-center">
      ...
      <Link href={'/create'} className='flex gap-1 items-center outline-none justify-center rounded-xl text-center bg-[#A23E18] px-4 py-2 text-[#FCF9F3] cursor-pointer transition-all duration-300 hover:scale-[90%]'>
