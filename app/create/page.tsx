            ...
            <div className=' w-full flex md:flex-row flex-col mt-8 md:mt-0 h-full justify-center items-center text-center gap-8'>
                {
                    cards.map((item) => (
                        <div key={item.id}>
                            <Link href={item.href} className='bg-white w-80 md:w-120 group relative hover:border-[#A23E18] h-80 gap-8 flex flex-col items-center justify-center z-50 py-8 px-12 rounded-xl shadow-lg hover:scale-[105%] hover:border-2  cursor-pointer duration-300'>
